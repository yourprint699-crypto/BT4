          ...
          <div className='space-y-12 floating-panel-dark p-8 lg:p-12'>
            ...
            <section className='space-y-4'>
              ...
              <div className='space-y-4'>
                <h3 className='font-[font2] text-xl uppercase text-layer-2'>Booking Process</h3>
                <ul className='font-[font1] text-lg leading-relaxed text-layer-1 space-y-2 list-disc list-inside'>
                ...
                <h3 className='font-[font2] text-xl uppercase text-layer-2 mt-6'>Cancellation Policy</h3>
                <ul className='font-[font1] text-lg leading-relaxed text-layer-1 space-y-2 list-disc list-inside'>
