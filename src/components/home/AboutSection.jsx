    ...
    <section id="about" ref={sectionRef} className='min-h-screen section-dark-alt text-white relative depth-3 section-transition'>
      ...
      <div className='container mx-auto lg:px-12 px-6 lg:py-32 py-20'>
        <div className='text-center mb-24 space-y-8'>
          <h2 className='about-title font-[font2] lg:text-[8vw] text-6xl uppercase mb-8 leading-tight text-layer-3 text-glow'>
            About Us
          </h2>
        </div>

        <div className='about-grid max-w-7xl mx-auto'>
          <div className='floating-panel-dark p-12 lg:p-16 mb-16'>
            <div className='grid lg:grid-cols-2 grid-cols-1 gap-12 lg:gap-16 items-center'>
            {/* Story Content */}
              <div className='about-content space-y-8'>
                <h3 className='font-[font2] text-3xl lg:text-4xl uppercase text-[#D3FD50] mb-6 text-layer-2 text-glow'>
                Our Story
                </h3>
                ...
                <div className='floating-quote'>
                  <p className='font-[font1] text-lg lg:text-xl leading-relaxed text-layer-2 italic'>
              ...
              <div className='about-content'>
                <div className='aspect-square rounded-3xl overflow-hidden video-glass gpu-accelerated'>
                <img 
          ...
          <div className='grid lg:grid-cols-3 grid-cols-1 gap-12 lg:gap-16'>
            <div className='about-content text-center space-y-4'>
              <div className='floating-panel-dark glass-hover p-8 lg:p-10 space-y-6'>
                <div className='text-4xl lg:text-5xl mb-4 micro-bounce glow-accent'>🎯</div>
                <h4 className='font-[font2] text-xl lg:text-2xl uppercase text-layer-2'>
                Vision
                </h4>
